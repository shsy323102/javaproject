            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
              <form id ="MDPF">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input data-options="required:true,validType:'length[4,8]'"  id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input data-options="required:true,validType:'length[4,8]'"  id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
              </form>
            </div>
