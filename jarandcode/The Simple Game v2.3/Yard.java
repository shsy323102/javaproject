...
public class Yard extends Frame{
    ...
    public static final int WINCOUNT=500;
   ...
   public void paint(Graphics g)
    {
    	...
    	if(score>=400)
    	{
    		...
    		g.drawString("明璐加油哦！",WIDE*SIZE-155,75);
    	}
    	if(score==WINCOUNT)
    	{
    		g.setColor(Color.BLUE);
    		g.setFont(new Font("宋体",Font.BOLD,20));
    		g.drawString("我一直喜欢着你，",WIDE*SIZE/2-120,HIGHT*SIZE/2+20);
    		g.drawString("用一切你知道或不知道的方式。",WIDE*SIZE/2-120,HIGHT*SIZE/2+40);
    	}
    	if(isOver==true && score!=WINCOUNT)
    	{
    		g.setColor(Color.BLUE);
    		g.setFont(new Font("宋体",Font.BOLD,20));
    		g.drawString("author:chenfu",WIDE*SIZE/2-80,HIGHT*SIZE/2+20);
    		g.drawString("Version:v2.2",WIDE*SIZE/2-80,HIGHT*SIZE/2+40);
    		g.drawString("按空格重新开始游戏",WIDE*SIZE/2-80,HIGHT*SIZE-200);
