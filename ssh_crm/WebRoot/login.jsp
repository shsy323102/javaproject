        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                <TD style="HEIGHT: 18px" colspan="3"><font color="red" size="5"><s:property value="exception.message"/></font></TD>
              ...
              <TR>
                 ...
                 <TD colspan="2" ><INPUT id=btn 
                  ...
                  <img src="images/regist_button.png" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/rejist.jsp'" >
