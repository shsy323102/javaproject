...
<SCRIPT language=javascript>
	...
	function selectCustomer(cust_id,cust_name){
		...
		dom.getElementById("cust_id").value=cust_id;
		dom.getElementById("cust_name").value=cust_name;
		window.close();
	};
</SCRIPT>
											...
											<TBODY>
												<TR>
													...
													<input type="hidden" name="customer.cust_id" id="cust_id"
														style="WIDTH: 180px" /> 
													<input type="text" name="cust_name" id="cust_name"  value="<s:property value="#parameters.cust_name" />" style="WIDTH: 180px" /> 
